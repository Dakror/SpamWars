...
public class BuildWeaponLayer extends MPLayer {
    ...
    public void renderWeaponStats(WeaponData cacheData) {
        ...
        Helper.drawHorizontallyCenteredString("Damage", 0, width, 0 + 151, g, 15);
    }
    ...
    public void init() {
        ...
        TextButton back = new TextButton(Game.getWidth() / 2 - TextButton.WIDTH, Game.getHeight() - TextButton.HEIGHT - 10, "Back");
        ...
        TextButton build = new TextButton(Game.getWidth() / 2, Game.getHeight() - TextButton.HEIGHT - 10, "Build");
        ...
        auto = new TextButton((Game.getWidth() - TextButton.WIDTH) / 2, Game.getHeight() - TextButton.HEIGHT * 2 - 10, "Manual");
        auto.setToggleMode(true);
        if (exisData != null) {
            auto.setSelected(exisData.isAutomatic());
            if (exisData.isAutomatic()) auto.setText("Auto");
        }
