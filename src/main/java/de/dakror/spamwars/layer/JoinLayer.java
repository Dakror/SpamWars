...
public class JoinLayer extends MPLayer {
    ...
    public void init() {
        ...
        components.add(back);
        TextButton update = new TextButton(Game.getWidth() / 2 - TextButton.WIDTH, Game.getHeight() - TextButton.HEIGHT * 2 - 10, "Search");
        ...
        TextButton enter = new TextButton(Game.getWidth() / 2, Game.getHeight() - TextButton.HEIGHT * 2 - 10, "Direct");
        ...
        TextButton join = new TextButton(Game.getWidth() / 2, Game.getHeight() - TextButton.HEIGHT - 10, "Join");
