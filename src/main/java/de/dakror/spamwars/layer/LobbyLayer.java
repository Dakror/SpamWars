...
public class LobbyLayer extends MPLayer {
    ...
    public void draw(Graphics2D g) {
        ...
        Helper.drawHorizontallyCenteredString("Options", Game.getWidth() / 4, 340, g, 28);

        Helper.drawHorizontallyCenteredString("Game mode", Game.getWidth() / 4, 480, g, 28);
        Helper.drawHorizontallyCenteredString("Time (min):", Game.getWidth() / 8, 580, g, 28);
    ...
    public void init() {
        ...
        TextButton map = new TextButton((Game.getWidth() / 4 - TextButton.WIDTH) / 2, 380, "Map");
        ...
        TextButton wpn = new TextButton(Game.getWidth() / 2 - TextButton.WIDTH / 2, Game.getHeight() / 4 * 3, "Weapon");
        ...
        start = new TextButton(Game.getWidth() / 2, Game.getHeight() / 4 * 3 + TextButton.HEIGHT, host ? "Start" : "Ready");
        ...
        TextButton disco = new TextButton(Game.getWidth() / 2 - TextButton.WIDTH, Game.getHeight() / 4 * 3 + TextButton.HEIGHT, "Leave");
