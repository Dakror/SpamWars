...
public class PauseLayer extends MPLayer {
    ...
    @Override
    public void init() {
        TextButton back = new TextButton(Game.getWidth() / 2 - TextButton.WIDTH / 2, Game.getHeight() / 2 - 90, "Continue");
        ...
        TextButton settings = new TextButton(Game.getWidth() / 2 - TextButton.WIDTH / 2, Game.getHeight() / 2 - 90 + TextButton.HEIGHT, "Options");
        ...
        TextButton disco = new TextButton(Game.getWidth() / 2 - TextButton.WIDTH / 2, Game.getHeight() / 2 - 90 + TextButton.HEIGHT * 2, "Leave");
