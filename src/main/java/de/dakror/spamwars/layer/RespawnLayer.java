...
public class RespawnLayer extends MPLayer {
    ...
    public void draw(Graphics2D g) {
        ...
        if (end > 0) {
            ...
            Helper.drawHorizontallyCenteredString("You are dead", Game.getWidth(), Game.getHeight() / 3, g, 90);
            Helper.drawHorizontallyCenteredString("Respawn next round", Game.getWidth(), Game.getHeight() / 3 + 100, g, 40);
        }
    }
